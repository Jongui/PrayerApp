...
class SearchUserDelegate extends SearchDelegate<String>{
  ...
  SearchUserDelegate({@required this.users, @required this.churchName});
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              margin: EdgeInsets.all(10.0),
              child: Text(
                AppLocalizations.of(context).confirmAddingUserToChurch(this.selectedUser.userName, churchName),
